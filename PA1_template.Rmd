...
### Preprocess the data
The data contains lots of missing values which would interfere and skew the data 
later on. So all rows containing missing data are removed here at this early 
stage. 
```{r}
